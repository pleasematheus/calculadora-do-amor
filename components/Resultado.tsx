...
// Piso de altura: o estado vazio é curto e a grade cheia é alta. Sem o piso o
// cartão desabaria justo quando a conta chega a zero — o desfecho mais comum.
...
export function Resultado({
  ...
  // grade é refeita do mesmo jeito. Só um profile em aparelho real diz se vale
  // um React.memo por figura; sem medida, não dá pra afirmar que vale.
  ...
  return (
    // Largura fluida com teto: no painel do desktop o cartão para em 520, e no
    // celular ele acompanha a coluna em vez de empurrar a página para fora da
    // tela. A altura sai do conteúdo, com o piso de ALTURA_MINIMA — com 520
    // fixo a grade estreita sobrava espaço vazio embaixo.
    <VStack
      width="100%"
    ...
    >
      {/* O fundo opaco do Card é o que separa o texto da foto que passa por
          trás. width 100% porque `repeat(auto-fill, …)` da grade lá dentro
          precisa de uma largura resolvida para contar as colunas. */}
      <Card padding={4} width="100%" minHeight={ALTURA_MINIMA}>
